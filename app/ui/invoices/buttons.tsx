...
export function UpdateInvoice({ id }: { id: string }) {
  return (
    <Link
      ...
      className="rounded-md border p-2 bg-khaki text-davysgray  hover:bg-davysgray hover:text-khaki"
    >
...
export function DeleteInvoice({ id }: { id: string }) {
  ...
  return (
    <form action={deleteInvoiceWithId}>
      <button className="rounded-md border p-2 bg-khaki text-davysgray hover:bg-davysgray hover:text-khaki">
